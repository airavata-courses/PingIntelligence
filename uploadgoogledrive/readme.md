This is a normal python file that connects with kafka topics "album" consuming the data, and uploading the photos on google drive and passing the images to photometadataserach service
